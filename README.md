# Mark Abraham Magumba — Portfolio Site

A responsive static portfolio designed for GitHub Pages.

## Publish on GitHub Pages

1. Sign in to GitHub and create a **public** repository named `Magumbian.github.io`.
2. Upload everything in this folder to the root of that repository.
3. Commit the files.
4. Open **Settings → Pages**.
5. Under **Build and deployment**, choose **Deploy from a branch**.
6. Select the `main` branch and `/ (root)`, then save.
7. The site will appear at `https://magumbian.github.io/`.
